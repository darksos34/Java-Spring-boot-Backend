package com.FullStack.auth.security.jwt;

import com.FullStack.auth.service.UserDetailsImpl;
...
public class JwtUtils {
	...
	@Value("${jordycoder.app.jwtSecret}")// Call JWT Secret Key from application.properties
	private String jwtSecret;

	@Value("${jordycoder.app.jwtExpirationMs}") // Call JWT Expiration time from application.properties
